...
```mermaid
flowchart TD
    GW["长城守卫军<br/>(守护边境 · 抵御魔种)"]
    SL["苏烈<br/>(不屈铁壁 · 前指挥官)"]
    LX["李信<br/>(一念神魔 · 接任指挥官)"]
    HML["花木兰<br/>(传说之刃 · 核心战力)"]
    K["铠<br/>(暗影游侠)"]
    SY["百里守约<br/>(神枪手 · 哥哥)"]
    XC["百里玄策<br/>(狼性少年 · 弟弟)"]
    GL["伽罗<br/>(破魔之箭)"]

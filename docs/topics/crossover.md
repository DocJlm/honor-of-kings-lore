...
- :material-bird: __娜可露露 · 鹰之守护者__

    ---

    与神鹰并肩的女剑士，自然与森林的代言人。纯刺客打野，机动收割。

    [→ 娜可露露](../heroes/liandong-snk.md#娜可露露)

- :material-sword: __橘右京 · 剑之千鸟__

    ---

    患病的浪客，以「一闪」居合追逐生命尽头的极致一剑。边路 / 打野刺客战士。

    [→ 橘右京](../heroes/liandong-snk.md#橘右京)

- :material-flower: __弗洛伦 · 花之剑客__

    ---

    西洋花剑的贵公子，拾花为契、连绵突进的对抗路高机动战士。

    [→ 弗洛伦](../heroes/liandong-snk.md#弗洛伦)

- :material-fire: __不知火舞 · 忍蜂__

    ---

    不知火流唯一传人，已被「血族之乱」收编入扶桑的本土忍者。

    [→ 不知火舞](../heroes/fusang-xuezu.md#不知火舞)
...
![王者大陆全图（扶桑位于最东端东风海域）](../assets/img/wangzhe-map.svg)
...
- :material-island: __扶桑 / 血族之地__

    ---

    不知火舞的落脚之地。东风海域最大岛屿，京都与血族巢穴并立，武道与血族恐怖交织。

    [→ 阵营页：扶桑 / 血族之地](../factions/fusang-xuezu.md)

- :material-account-group: __联动英雄（客座）__

    ---

    娜可露露、橘右京、弗洛伦所属的独立客座分组。

    [→ 阵营页：联动英雄](../factions/liandong-snk.md)

- :material-earth: __王者大陆 · 地理图志__

    ---

    在地图上看清扶桑 / 东风海域的位置，理解联动英雄的地理落点。

    [→ 地理图志](../worldview/map.md)

- :material-vector-difference: __专题 · 平行宇宙__

    ---

    辨析「跨 IP 联动」与「同 IP 世界线分支」的区别——两类「他处来客」的不同机制。

    [→ 专题：平行宇宙](parallel-worlds.md)

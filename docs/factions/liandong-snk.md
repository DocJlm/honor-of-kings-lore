...
- :material-door-open: **客座分组**

    ---

    不是国、不是城、不是教团，而是一个**收纳格**——专门安置跨 IP 联动而来、却未被主线收编的外来英雄。

- :material-sword-cross: **剑客底色**

    ---

    三位成员清一色是「**剑客**」：娜可露露的短刀与神鹰、橘右京的居合长刀、弗洛伦的西洋花剑。冷兵器与近身搏杀，是他们共同的语言。

- :material-earth: **混搭美学**

    ---

    东瀛和风 × 西洋骑士风并置一处，没有统一的视觉基调，「**混搭即底色**」本身就是本组的特色。

- :material-account-question: **外来者立场**

    ---

    世界观上保持「客人」身份，不隶属任何主线阵营，也不卷入大陆的国族纷争——他们是峡谷里**最纯粹的「过客」**。
...
??? quote "原作小考 · 三客在「别处」的来历（IP 背景 · 考据）"
...
- :material-account-group: **英雄合集**
    ...
    [联动英雄 · 英雄页](../heroes/liandong-snk.md) —— 娜可露露、橘右京、弗洛伦三位客座剑客的完整档案与机制详解。

- :material-link-variant: **联动专题**

    ---

    [专题 · 联动宇宙](../topics/crossover.md) —— 跨 IP 客座英雄的总览，「一收一留」处理逻辑，及联动与主世界线的关系辨析。

- :material-island: **同源对照阵营**

    ---

    [扶桑 / 血族之地](../factions/fusang-xuezu.md) —— 收编了 SNK 同源角色[不知火舞](../heroes/fusang-xuezu.md#不知火舞)的主线阵营，是本组「客居」之路最好的对照。

- :material-shape-outline: **同区姊妹分组**

    ---

    [上古遗族 / 神话杂项与多职业](../factions/yuanchu-shenhua-misc.md) —— 同属「联动 · 其他」大区的另一个非主线收纳格。

- :material-map: **世界观地图**

    ---

    [世界观地图](../worldview/map.md) —— 看清王者大陆的版图全貌，理解为何「客座分组」在地图上找不到对应实土。

- :material-timeline-clock: **纪元编年**

    ---

    [纪元编年](../worldview/eras.md) —— 王者世界观的主世界线与平行时空脉络，联动支线在其中的「平行并存」位置。

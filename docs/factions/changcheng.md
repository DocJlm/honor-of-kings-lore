...
- :material-target: **百里兄弟 · 守约与重逢**

    [百里守约](../heroes/changcheng.md#百里守约)与[百里玄策](../heroes/changcheng.md#百里玄策)本是住在长城畔小镇、约定「永不分离」的亲兄弟。玄策被马贼掳走后，守约因自责「未守住约定」而改名「守约」、加入长城守卫军，以期在这道墙上等待与弟弟重逢。详见 [人物关系 · 亲缘](../relationships/kinship.md)。

- :material-knife-military: **狼性少年 · 从暗影到长城**

    [百里玄策](../heroes/changcheng.md#百里玄策)被[铠](../heroes/changan.md#铠)所救，又被[兰陵王](../heroes/modao-shadow-abyss.md#兰陵王)收为徒、授以暗影潜行与钩镰杀戮；最终兰陵王将他**托付给[花木兰](../heroes/changan.md#花木兰)**，玄策由此踏入长城——一段「魔道授艺、铁壁收容」的奇特因缘。详见 [人物关系 · 师徒](../relationships/mentor.md)。

- :material-sword-cross: **双兰 · 墙下的宿命交锋**

    长城小队队长[花木兰](../heroes/changan.md#花木兰)，常与潜入长城的暗影刀锋[兰陵王](../heroes/modao-shadow-abyss.md#兰陵王)交锋。这场发生在太古之墙阴影里的「双兰」对决，是立场与情感交织的宿命之战。详见 [人物关系 · 宿敌](../relationships/rivalry.md)。

- :material-shield-account: **铁壁与神魔 · 统帅的传承**

    [苏烈](../heroes/changcheng.md#苏烈)接纳并教导流落街头的[李信](../heroes/changan.md#李信)，李信后接任长城指挥官——从「不屈铁壁」到「一念神魔」，是长城守卫军统帅交替与「以人传人」包容精神的缩影。

</div>

!!! example "剧情焦点 · 一墙之上，万族同袍"
...
- :material-account-star: **长城守卫军英雄图鉴**

    本阵营全体英雄的档案、背景与台词，见 [长城守卫军英雄页](../heroes/changcheng.md)。

- :material-timeline-clock: **纪元编年**

    长城关闭、魔种叩关与北疆黑暗时代的来龙去脉，见 [纪元编年](../worldview/eras.md)。

- :material-map: **王者大陆地图**

    长城、云中漠地与北疆地理格局的全貌，见 [地图](../worldview/map.md)。

- :material-book-open-variant: **世界观总览**

    等级金字塔、魔道与魔种、源能污染的底层骨架，见 [世界观总览](../worldview/overview.md)。

- :material-weather-sunny: **相邻阵营 · 云中漠地**

    长城西邻、攻防对峙的衰败大漠，见 [云中漠地·边陲](../factions/yunzhong-modi.md)。

- :material-skull: **对峙阵营 · 魔道·暗影·深渊**

    催生大漠魔种的暗面源头，见 [魔道·暗影·深渊](../factions/modao-shadow-abyss.md)。

- :material-city: **关联阵营 · 长安城**

    共享统帅与小队、向北戍边的帝国中枢，见 [长安城](../factions/changan.md)。

- :material-graph: **人物关系总览**

    以关系网读懂长城群英的血缘、师承与宿命，见 [人物关系](../relationships/index.md)。

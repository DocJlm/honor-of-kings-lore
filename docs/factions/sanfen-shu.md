...
- :material-peach: **侠义桃源的世外仙境**

    益城山清水秀、桃花绚烂，是带神秘感的「世外桃源」，桃林既是风光，也是「桃园结义」的精神符号。

- :material-account-group: **英雄最多的群英集团**

    收录 9 位英雄，是全大陆英雄数量最多的单一阵营，几乎撑起三分之地三国群像的半壁江山。

- :material-sword-cross: **五虎齐备·定位最全**

    桃园结义 + 五虎将，从远射战士、骑战、战刺、肉盾辅助到法师、射手、刺客，几乎覆盖全部职业定位。

- :material-link-variant: **羁绊网最绵密**

    对外有蜀吴联姻、刘禅单恋蔡文姬的跨阵营情缘；对内有诸葛亮与元歌的稷下同窗、与司马懿的挚友兼宿敌。
...
!!! example "蜀国之主 · [刘备](../heroes/sanfen-shu.md#刘备)（仁德义枭）"
...
- :material-account-star: **蜀国英雄图鉴**

    本阵营 9 位英雄的完整档案、背景与定位，见 [蜀国英雄页](../heroes/sanfen-shu.md)。

- :material-sword: **同区·三分之地·魏国**

    蜀国的主要宿敌，诸葛亮 vs 司马懿、刘禅暗恋蔡文姬的关系另一端，见 [三分之地·魏国](../factions/sanfen-wei.md)。

- :material-waves: **同区·三分之地·吴国**

    蜀吴联姻的另一端，孙尚香的归属地，见 [三分之地·吴国](../factions/sanfen-wu.md)。

- :material-school: **关联·稷下学院**

    诸葛亮、元歌的求学之地，「稷下F4」结缘的舞台，见 [稷下学院](../factions/jixia.md)。

- :material-map: **王者大陆地图**

    三分之地与益城在大陆上的方位与势力边界，见 [王者大陆地图](../worldview/map.md)。

- :material-timeline-clock: **纪元编年**

    三分纷争、蜀吴联姻、稷下渊源等事件的世界观坐标，见 [纪元编年](../worldview/eras.md)。

- :material-calendar-text: **大事年表**

    魏蜀吴纷争在人类时代时间线上的位置，见 [大事年表](../worldview/timeline.md)。
